...
Data used in this script are the total amount of agricultural subsidies each US county received from 2010 - 2019. Data and code are available on [github](https://github.com/haleyepperlyfox/ag-subsidies-gganimate). These data were scraped from this [website](https://farm.ewg.org/) managed by the Environmental Working Group (see [tutorial](https://rpubs.com/haleyepperlyfox/916671) for scraping these data). To make these data comparable across years, I have adjusted all dollar amounts for regional inflation so they are all represented in 2019 dollars.
...
Read in data from the github [repository](https://github.com/haleyepperlyfox/ag-subsidies-gganimate).
